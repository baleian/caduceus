...
## Overview
These resiliency rules are MANDATORY cross-cutting constraints that apply across all AI-DLC phases. They are derived from established reliability and resilience engineering best practices and apply to workloads on any platform or cloud provider. The rules are organized across six pillars: Business Goals, Change Management & Automation, Integrated Observability, High Availability, Disaster Recovery, and Continuous Improvement.
...
## Appendix: Reliability Concept Mapping

The following table maps each rule to a corresponding concept in standard reliability engineering. This mapping is informational and demonstrates alignment with widely established reliability practices. The rules themselves are platform- and cloud-provider-agnostic.
...
## Appendix: Rule-to-Pillar Mapping

The following table groups each rule under the six resiliency pillars introduced in the Overview. This mapping is informational; the rules apply to any platform or cloud provider.
