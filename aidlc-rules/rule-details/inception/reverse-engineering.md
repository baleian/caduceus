...
- Package types: Application, Infrastructure (IaC), Models, Clients, Tests
...
- Infrastructure-as-Code definitions (e.g., Terraform, Pulumi, OpenTofu)
- Container/orchestration manifests (Dockerfiles, Kubernetes/Helm, Compose)
- Deployment scripts

### 1.4 Build System Discovery
- Build systems: Maven, Gradle, npm, Make
- Config files for build-system declarations
- Build dependencies between packages

### 1.5 Service Architecture Discovery
- Serverless functions (handlers, triggers)
- Container services (Docker, Kubernetes, orchestration configs)
- API definitions (OpenAPI/Swagger, gRPC/Protobuf, GraphQL schemas)
- Data stores (relational databases, NoSQL stores, object storage, caches)
...
- **Infrastructure-as-Code**: [List with purposes]
- **Deployment Model**: [Description]
- **Networking**: [networks, subnets, security/firewall rules]
```
